...
2. Clone/Download the repository. Type in your terminal one of the following options:
   ...
   ```bash
   # Git
   git clone https://github.com/WisdmLabs/google-pagespeed-bulk.git

   # OR Github's CLI
   gh repo clone https://github.com/WisdmLabs/google-pagespeed-bulk
   ```
...
7. You can change the number of tests per URL you'd like to perform. Change the variable `numTest` in Line 16 of index.js to your desired number of tests. Maximum recommended 5.
   ```javascript
